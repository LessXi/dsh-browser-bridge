...
> **当前状态：v92 已交付并入库。** 下一节就是最新的一轮改动；下面标 … 的段落是历史层，越往下越旧。
> 只想知道「现在能做什么、下一步做什么」，读到 v92 那一段为止即可。
>
...
>
> **已入库**：v3→v92 的全部改动已提交并推送到 `origin/main`。工作区干净。
> （v91 是 `3d96bf1`，v90 是 `767e4cd`，v80 是 `53602de`，v79 是 `5c8ee77`，v78 是 `768e653`，v77 是 `322fdc4`，v75 是 `e0ef3ee`，v74 是 `bb5af8d`。）
