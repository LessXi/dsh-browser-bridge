...
> **当前状态：v29 已交付。** 下一节就是最新的一轮改动；下面标 v28/v27/v14/v13/v12/v11/v10/v9/v8/v3/v4/v5/… 的段落是历史层，越往下越旧。
> 只想知道「现在能做什么、下一步做什么」，读到 v29 那一段为止即可。
>
> **环境前提：本仓库不需要 `pnpm install`。** 全新克隆后 `npm test`（391 条）与
