...
> **当前状态：v72 已交付并入库。** 下一节就是最新的一轮改动；下面标 v71/v70/v69/v68/v67/v66/v65/v64/v63/v61/v60/v59/v58/v57/v56/v55/v54/v53/v52/v44/v43/v42/v41/v40/v39/v38/v37/v36/v35/v34/v33/v32/v31/v30/v29/v28/v27/v14/v13/v12/v11/v10/v9/v8/v3/v4/v5/… 的段落是历史层，越往下越旧。
> 只想知道「现在能做什么、下一步做什么」，读到 v72 那一段为止即可。
>
> **环境前提：本仓库不需要 `pnpm install`。** 全新克隆后 `npm test`（553 条）与
...
>
> **已入库**：HEAD = `84713c0`（2026-09-23），v3→v71 的全部改动已提交并推送到
> `origin/main`；v72 在本轮提交。工作区干净。（此前的 `2ea6baf` 是 v2 的最后一个提交。）
